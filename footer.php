<footer class='site-footer container-fluid pt-4 bg-white position-relative border-top'>
        <div class='container'>
            <div class='row'>
                ...
                <div class='col-12 col-md-4 text-center text-md-start pb-2'><!--Menu pages légales-->
                    <?php wp_nav_menu( array( 'theme_location' => 'footer-menu','menu_class' => 'menu-footer p-0','container' => 'nav' ) ); ?>
                </div>
    ...
    <script src='<?php echo get_template_directory_uri(); ?>/assets/js/nav-fixed-megamenu.js' async defer></script>
